...
class ApplicationDaoTest {
    ...
    fun insertApplicationAndGetByName() {
        val inserted = App(DEFAULT_NON_AUTOGENERATED_ID, name = DEFAULT_NAME)
    ...
    fun dbApplicationIsReplacedOnConflict() {
        val app1 = App(DEFAULT_NON_AUTOGENERATED_ID, name = "one")
        val app2 = App(DEFAULT_NON_AUTOGENERATED_ID, name = "two")

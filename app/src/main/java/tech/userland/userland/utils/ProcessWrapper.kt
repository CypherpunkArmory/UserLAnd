...
class ProcessWrapper(pb: ProcessBuilder, stdOutListener: (String) -> Int) {
...
//    val stdOutReader: Thread
    ...
    init {
//        process = pb.start()
        // TODO guarantee this is the pid
        pid = process.toString().substringAfter("=").substringBefore(",").toLong()

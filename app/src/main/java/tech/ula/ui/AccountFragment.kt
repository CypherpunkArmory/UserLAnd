...
class AccountFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        button_account_register.setOnClickListener {
            val intent =
                Intent("android.intent.action.VIEW", Uri.parse("https://userland.tech/signup"))
        ...
        input_account_email.addTextChangedListener(object : TextWatcher {
            override fun afterTextChanged(p0: Editable?) {
                val accountPrefs =
                    getActivity()?.getSharedPreferences("account", Context.MODE_PRIVATE) ?: return
    ...
    private fun saveAccountInfo(): Boolean {
        ...
        val accountPrefs =
            this.getActivity()?.getSharedPreferences("account", Context.MODE_PRIVATE) ?: return true
        with(accountPrefs.edit()) {
